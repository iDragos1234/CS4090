"""TODO.md write about connections"""
    ...
    def _add_epr_commands(
        ...
        **kwargs,
        ...
        if instruction == Instruction.CREATE_EPR:
            # request arguments
            # TODO.md add other args
            create_kwargs = {}
            create_kwargs['type'] = tp
            create_kwargs['number'] = number
            # TODO.md currently this give 50 / 50 since with the current link layer
            ...
            # TODO.md don't create a new array if already created from previous command
