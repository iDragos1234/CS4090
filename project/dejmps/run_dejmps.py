...
def main():
    ...
    GRID_SIZE = 3  # Set the number of values in the interval [0, 1] for each parameter
    NUM_SAMPLES = 100  # Set number of samples for each parameter configuration
    MAX_ATTEMPTS = 2  # Maximum number of attempts for generating a single sample
        ...
        for gate_fidelity in [1.0]:
            ...
            for epr_fidelity in [0.8]:
                ...
                for sample_idx in range(NUM_SAMPLES):
                    ...
                    flag = False
                    attempt_num = 0
                    while flag and attempt_num < MAX_ATTEMPTS:
                        try:
                    ...
                    print(results[-1])
                    # TODO: Implement fail safety (after each param config, trying multiple times etc.)
    finally:
        print('Saving ...')
