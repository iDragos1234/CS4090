...
def main():
    ...
    try:
        for num_iters in ITERATIONS_SWEEP:
            os.environ["NUM_ITERATIONS"] = str(num_iters)  # Set env var
            for gate_fidelity in GATE_FID_SWEEP:
                ...
                for epr_fidelity in EPR_FID_SWEEP:
                    ...
                    for sample_idx in range(NUM_SAMPLES):
                        ...
                        results.append([num_iters, gate_fidelity, epr_fidelity, sample_idx, m_alice, m_bob, fidelity])
                        print(results[-1])
